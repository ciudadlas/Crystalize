//
//  TableCellCustomColoredAccessory.m
//  travel
//
...
@implementation TableCellCustomColoredAccessory
...
{
	TableCellCustomColoredAccessory *ret = [[TableCellCustomColoredAccessory alloc] initWithFrame:CGRectMake(0, 0, 11.0, 15.0)];
