...
- (void)insertNewObject:(id)sender
{
    ...
    // get template
    NSString *templatePath = [[NSBundle mainBundle] pathForResource:@"starter" ofType:@"plist"];
    NSDictionary *templateDict = [[NSDictionary alloc] initWithContentsOfFile:templatePath];

    [Idea ideaWithTemplateDictionary:templateDict inManagedObjectContext:context];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    av.opaque = NO;
    av.image = [UIImage imageNamed:@"shelf-background.png"];
...
{
    if ([[segue identifier] isEqualToString:@"ShowIdea"]) {
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        Idea *idea = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        [[segue destinationViewController] setIdea:idea];
    }
}
...
{
    Idea *idea = [self.fetchedResultsController objectAtIndexPath:indexPath];
    ((IdeasTableViewCell *)cell).idea = idea;
